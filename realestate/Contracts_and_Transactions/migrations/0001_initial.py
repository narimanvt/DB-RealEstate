...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Clients_and_Contacts', '0002_auto_20240202_1202'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_type_name', models.CharField(choices=[('Buy', 'Buy'), ('Rent', 'Rent'), ('Barter', 'Barter'), ('Mortgage', 'Mortgage'), ('Pre-Sale', 'Pre-Sale'), ('Lease And Rent', 'Lease And Rent')], max_length=64, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Under_contract',
